...
def plot_predicted_vs_actual(
    ...
    ax.legend()
    mae_val = metrics['mean_absolute_error'] if metrics['mean_absolute_error'] is not None else 'N/A'
    rho_val = metrics['rank_correlation'] if metrics['rank_correlation'] is not None else 'N/A'
    ax.text(
        0.05, 0.93,
        f"MAE={mae_val}  ρ={rho_val}",
